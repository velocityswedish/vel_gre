...
def generate_video_metadata(category: str, num_phrases: int):
    """Generate Greek title, description, and tags for the video"""

    title = f"Μάθετε Ελληνικά: {num_phrases} Βασικές Φράσεις {category} 🇬🇷"

    description = f"""Μάθετε {num_phrases} βασικές ελληνικές φράσεις για {category}!

Ιδανικό για αρχάριους που μαθαίνουν Ελληνικά. Κάθε φράση περιλαμβάνει:
✅ Αγγλική φράση
✅ Ελληνική μετάφραση
✅ Οδηγό προφοράς
✅ Πλαίσιο χρήσης

Εγγραφείτε για καθημερινά μαθήματα Ελληνικών!

#ΜάθετεΕλληνικά #ΕλληνικάΜαθήματα #ΕλληνικάΓιαΑρχάριους #ΕκμάθησηΓλωσσών
#Ελληνικά #Εκπαίδευση #Tutorial #ΚαθημερινάΕλληνικά #{category.replace(' ', '')}
"""
...
def upload_to_youtube(video_path, title, description, tags=None, category_id='27'):
    ...
    if tags is None:
        tags = ['μάθετε ελληνικά', 'greek lessons']
...
def main():
    ...
    # Generate Greek metadata for test
    title = "Μάθετε Ελληνικά: 5 Βασικές Φράσεις Παρακίνηση 🇬🇷"
    description = "Μάθετε 5 βασικές ελληνικές φράσεις για Παρακίνηση! #ΜάθετεΕλληνικά #ΕλληνικάΜαθήματα"
    tags = ['μάθετε ελληνικά', 'greek lessons', 'παρακίνηση']
